...
public interface Messages {
    ...
    String MOVIE_CHECKOUT_SUCCESSFUL = "Thank you! Enjoy the book" ;
    String MOVIE_CHECKOUT_UNSUCCESSFUL = "The book is not available";
    String MOVIE_RETURN_SUCCESSFUL = "Thank you for returning book";
    String MOVIE_RETURN_UNSUCCESSFUL = "That is not a valid book to return";
}
